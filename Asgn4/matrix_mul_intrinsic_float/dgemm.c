                ...
                for(bj = 0; bj < n; bj+=BLOCKSIZE) {
                        for(i = 0; i < n; i+=2){
                                for(k = bk; k < min(n, bk+BLOCKSIZE); k+=2){
                                	__m256 a1_r = _mm256_set_ps(a[i * n + k], a[i * n + k], a[i * n + k], a[i * n + k], a[i * n + k], a[i * n + k], a[i * n + k], a[i * n + k]);
                                        __m256 a2_r = _mm256_set_ps(a[i * n + k + 1], a[i * n + k + 1], a[i * n + k + 1], a[i * n + k + 1], a[i * n + k + 1], a[i * n + k + 1], a[i * n + k + 1], a[i * n + k + 1]);
                                        __m256 a3_r = _mm256_set_ps(a[(i+1) * n + k], a[(i+1) * n + k], a[(i+1) * n + k], a[(i+1) * n + k], a[(i+1) * n + k], a[(i+1) * n + k], a[(i+1) * n + k], a[(i+1) * n + k]);
                                        __m256 a4_r = _mm256_set_ps(a[(i+1) * n + k+1], a[(i+1) * n + k+1], a[(i+1) * n + k+1], a[(i+1) * n + k+1], a[(i+1) * n + k+1], a[(i+1) * n + k+1], a[(i+1) * n + k+1], a[(i+1) * n + k+1]);
 					#pragma ivdep 
                                        {
                                        	for(j = bj ; j < min(n, bj + BLOCKSIZE); j+=16){
                                                	__m256 c1_r = _mm256_load_ps(&c[i * n + j]);
                                                        __m256 c2_r = _mm256_load_ps(&c[i * n + j + 8]);
                                                        __m256 c3_r = _mm256_load_ps(&c[(i+1) * n + j]);
                                                        __m256 c4_r = _mm256_load_ps(&c[(i+1) * n + j + 8]);
                                                        __m256 b1_r = _mm256_load_ps(&b[k * n + j]);
                                                        __m256 b2_r = _mm256_load_ps(&b[k * n + j + 8]);
                                                        __m256 b3_r = _mm256_load_ps(&b[(k+1) * n + j]);
                                                        __m256 b4_r = _mm256_load_ps(&b[(k+1) * n + j + 8]);
                                                        ...
                                                        _mm256_store_ps(&c[i * n + j + 8], c2_r);
                                                        _mm256_store_ps(&c[(i+1) * n + j], c3_r);
                                                        _mm256_store_ps(&c[(i+1) * n + j + 8], c4_r);
                                                        //c[i * n + j] += r * b[k * n + j];
                               		        }
                                        }
                                }
